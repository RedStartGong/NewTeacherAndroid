...
public class EvaluateAdapter extends RecyclerView.Adapter<EvaluateAdapter.SimpleViewHolder> {
    ...
    private List<EvaluateTag> mBeans = new ArrayList<>();
    ...
    public SimpleViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        final View view = LayoutInflater.from(mContext).inflate(R.layout.item_evaluate_tab, parent, false);
        ...
        if (mBeans.size() % 4 != 0) {
            ...
            if (position == itemCount - 1) {
                ...
                if (mBeans.size() % 4 == 3) {
                    ...
                    holder.tagTextAdapter1 = new TagTextAdapter<>(mContext);
                    holder.tagTextAdapter2 = new TagTextAdapter<>(mContext);
                    holder.tagTextAdapter3 = new TagTextAdapter<>(mContext);
                    ...
                    holder.title1.setText(mBeans.get(position * 4).getThreeindexname());
                    holder.title2.setText(mBeans.get(position * 4 + 1).getThreeindexname());
                    holder.title3.setText(mBeans.get(position * 4 + 2).getThreeindexname());
                } else if (mBeans.size() % 4 == 2) {
                ...
                holder.tagTextAdapter2 = new TagTextAdapter<>(mContext);
                holder.tagTextAdapter3 = new TagTextAdapter<>(mContext);
                holder.tagTextAdapter4 = new TagTextAdapter<>(mContext);
                holder.tagEvaluate1.setTagCheckedMode(FlowTagLayout.FLOW_TAG_CHECKED_SINGLE);
                holder.tagEvaluate2.setTagCheckedMode(FlowTagLayout.FLOW_TAG_CHECKED_SINGLE);
                holder.tagEvaluate3.setTagCheckedMode(FlowTagLayout.FLOW_TAG_CHECKED_SINGLE);
                ...
                holder.title2.setText(mBeans.get(position * 4 + 1).getThreeindexname());
                holder.title3.setText(mBeans.get(position * 4 + 2).getThreeindexname());
                holder.title4.setText(mBeans.get(position * 4 + 3).getThreeindexname());
            }
        } else {
            holder.arrowNext.setVisibility(View.VISIBLE);
            holder.arrowBack.setVisibility(View.VISIBLE);
        ...
        holder.tagEvaluate1.setOnTagSelectListener(new OnTagSelectListener() {
            ...
            public void onItemSelect(FlowTagLayout parent, List<Integer> selectedList) {
                ...
                if (selectedList != null && selectedList.size() > 0) {
                    ...
                    map.put(position * 4, mBeans.get(position * 4).getPackageName() + "!" +
                            mBeans.get(position * 4).getIndexName() + "!" + sb.toString());
                } else {
        ...
        holder.tagEvaluate2.setOnTagSelectListener(new OnTagSelectListener() {
            ...
            public void onItemSelect(FlowTagLayout parent, List<Integer> selectedList) {
                ...
                if (selectedList != null && selectedList.size() > 0) {
                    ...
                    map.put(position * 4 + 1, mBeans.get(position * 4 + 1).getPackageName() + "!" +
                            mBeans.get(position * 4 + 1).getIndexName() + "!" + sb.toString());
        ...
        holder.tagEvaluate3.setOnTagSelectListener(new OnTagSelectListener() {
            ...
            public void onItemSelect(FlowTagLayout parent, List<Integer> selectedList) {
                ...
                if (selectedList != null && selectedList.size() > 0) {
                    ...
                    map.put(position * 4 + 2, mBeans.get(position * 4 + 2).getPackageName() + "!" +
                            mBeans.get(position * 4 + 2).getIndexName() + "!" + sb.toString());
                } else {
        ...
        holder.tagEvaluate4.setOnTagSelectListener(new OnTagSelectListener() {
            ...
            public void onItemSelect(FlowTagLayout parent, List<Integer> selectedList) {
                ...
                if (selectedList != null && selectedList.size() > 0) {
                    ...
                    map.put(position * 4 + 3, mBeans.get(position * 4 + 3).getPackageName() + "!" +
                            mBeans.get(position * 4 + 3).getIndexName() + "!" + sb.toString());
                } else {
